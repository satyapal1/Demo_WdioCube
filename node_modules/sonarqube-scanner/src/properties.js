...
function getHostProperties(properties) {
    ...
    if (!sonarHostUrl || sonarCloudSpecified) {
        ...
        switch (region) {
            case '': {
                defaultCloudUrl = constants_1.SONARCLOUD_URL;
                defaultApiUrl = constants_1.SONARCLOUD_API_BASE_URL;
                break;
            }
            case constants_1.REGION_US: {
        ...
        return {
            ...
            [types_1.ScannerProperty.SonarHostUrl]: properties[types_1.ScannerProperty.SonarScannerSonarCloudUrl] ?? defaultCloudUrl,
            [types_1.ScannerProperty.SonarScannerApiBaseUrl]: sonarApiBaseUrl ?? defaultApiUrl,
        };
    }
    else {
        return {
...
function isSonarCloud(properties, sonarHostUrl) {
    return (properties[types_1.ScannerProperty.SonarScannerSonarCloudUrl] === sonarHostUrl ||
        ...
        constants_1.SONARCLOUD_US_URL_REGEX.exec(sonarHostUrl ?? ''));
}
